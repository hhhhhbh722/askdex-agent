...
from app.api.routes import chat, conversation, document, evaluation, health, kg, trace
...
from app.infrastructure.observability import setup_otel
...
def create_app() -> FastAPI:
    ...
    setup_otel(app, service_name=s.app_name)
    ...
    app.include_router(evaluation.router, prefix=s.api_prefix)
    app.include_router(kg.router, prefix=s.api_prefix)
    app.include_router(trace.router, prefix=s.api_prefix)
